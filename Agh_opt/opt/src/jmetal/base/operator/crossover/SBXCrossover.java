...
public class SBXCrossover {
	...
	/**
	 * Constructor. Create a new SBX crossover specifying a index crossover
	 * value
	 * 
	 * @param indexCrossover
	 *            The index crossover
	 */
	 ...
	 */
	public Solution[] doCrossover(double probability, Solution parent1, Solution parent2) throws Exception {
