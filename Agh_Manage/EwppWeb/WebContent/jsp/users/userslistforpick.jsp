...
jQuery(document).ready(function(){ 
	  jQuery("#list").jqGrid({
	    ...
	    loadComplete: function(){ 
		    ...
		    for(var i=0;i<ids.length;i++){ 
			    ...
			    be = "<img src=\"gfx/stock_new-bcard.png\" border=\"0\" onclick=\"addRecipient('"
	...
	function addRecipient(id, firstName, lastName) {
		$("#recipientsTab").append(
				"<tr id=\"tr"+id+"\"><td>"
				+firstName+" "+lastName+
				"<img src=\"gfx/cancel.png\" onclick=\"removeRecipient('"+id+"'); \"/>"+
				"</td></tr>"
		);

		$("#hidOperation").parent().append(
				"<input type=\"hidden\" id=\"hid"+id+"\" value=\""+id+"\" name=\"recipientsId\"/>"
		);
		$.nyroModalRemove();
	}
</script>
